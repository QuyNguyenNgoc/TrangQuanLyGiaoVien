...
import { ComboboxItemDto, CommonLookupServiceProxy, SettingScopes, HostSettingsEditDto, HostSettingsServiceProxy, SendTestEmailInput, TemplatesServiceProxy } from '@shared/service-proxies/service-proxies';
...
export class HostSettingsComponent extends AppComponentBase implements OnInit {
    ...
    sendTestEmail(): void {
        ...
        input.body = "<p>jadqjaubdu</p>";
        input.subject = "ànuewfuuewfnu";
