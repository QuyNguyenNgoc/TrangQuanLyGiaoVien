...
/*
  ...
  Contact: Lyubomir Arsov, liubo (at) web-lobby.com
*/
var AuthToken = Cookies.get('Abp.AuthToken');
...
function Directory(fullPath, numDirs, numFiles){
  ...
  this.LoadAll = function(selectedDir){
    ...
    dirListURL = RoxyUtils.AddParam(dirListURL, 'type', RoxyUtils.GetUrlParam('type'));
      ...
      //};
      //console.warn('customHeaders' + customHeaders.Authorization);
      var dir = this;
      // var AuthToken = Cookies.get('Abp.AuthToken');
      ...
      // var test =
      //     'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..1znON-ypAFt5Du0MFKHWied_i9IBoTzwzq-x5JiECuY';
      // var customHeaders = {
      //     'Authorization': 'Bearer ' + AuthToken
      // };
    $.ajax({
...
function previewFile(){
  var f = getSelectedFile();
  if(f){
    window.open(RoxyFilemanConf.SERVER_PREFIX + f.fullPath);
  }
}
