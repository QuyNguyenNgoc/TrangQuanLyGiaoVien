...
using Hinnova.MultiTenancy.HostDashboard;
...
namespace Hinnova.Tests.HostDashboard
{
    ...
    public class HostDashboardAppService_Tests : AppTestBase
    {
        ...
        private void CreatePaidPayment(HinnovaDbContext context, SubscriptionPayment subscriptionPayment)
        {
