...
using Hinnova.EntityFrameworkCore.Repositories;

namespace Hinnova.MultiTenancy.Payments
{
    public class SubscriptionPaymentRepository : HinnovaRepositoryBase<SubscriptionPayment, long>, ISubscriptionPaymentRepository
    {
        public SubscriptionPaymentRepository(IDbContextProvider<HinnovaDbContext> dbContextProvider)
