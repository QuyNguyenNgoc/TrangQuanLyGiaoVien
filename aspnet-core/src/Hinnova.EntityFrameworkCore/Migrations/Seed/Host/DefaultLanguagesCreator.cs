...
namespace Hinnova.Migrations.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        ...
        {
            var tenantId = HinnovaConsts.MultiTenancyEnabled ? null : (int?)1;
        ...
        public DefaultLanguagesCreator(HinnovaDbContext context)
        {
            _context = context;
        }
