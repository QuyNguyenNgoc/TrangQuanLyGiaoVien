...
namespace Hinnova.Web.Public.Startup
{
    ...
    public class HinnovaWebFrontEndModule : AbpModule
    {
        private readonly IConfigurationRoot _appConfiguration;

        public HinnovaWebFrontEndModule(IWebHostEnvironment env, HinnovaEntityFrameworkCoreModule abpZeroTemplateEntityFrameworkCoreModule)
        {
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(HinnovaWebFrontEndModule).GetAssembly());
        }
    }
}
