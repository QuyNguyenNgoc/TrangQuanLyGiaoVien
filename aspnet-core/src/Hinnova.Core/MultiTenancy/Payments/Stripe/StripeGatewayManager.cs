...
namespace Hinnova.MultiTenancy.Payments.Stripe
{
    ...
    public class StripeGatewayManager : HinnovaServiceBase,
        ...
        ITransientDependency
    {
        ...
        public static string ProductName = "Hinnova";
        ...
        {
            return editionName + "_" + paymentPeriodType + "_" + HinnovaConsts.Currency;
        }
