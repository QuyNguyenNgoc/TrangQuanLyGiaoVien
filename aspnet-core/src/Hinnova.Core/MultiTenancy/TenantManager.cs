...
using Hinnova.MultiTenancy.Demo;
...
namespace Hinnova.MultiTenancy
{
    ...
    public class TenantManager : AbpTenantManager<Tenant, User>
    {
        ...
        public async Task CheckEditionAsync(int? editionId, bool isInTrialPeriod)
        {
            ...
            var error = LocalizationManager.GetSource(HinnovaConsts.LocalizationSourceName).GetString("FreeEditionsCannotHaveTrialVersions");
