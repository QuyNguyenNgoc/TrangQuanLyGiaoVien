...
namespace Hinnova.Authentication.TwoFactor.Google
{
    public class GoogleAuthenticatorProvider : HinnovaServiceBase, IUserTwoFactorTokenProvider<User>, ITransientDependency
    {
        ...
        public Task<string> GenerateAsync(string purpose, UserManager<User> userManager, User user)
        {
            ...
            var setupInfo = _googleTwoFactorAuthenticateService.GenerateSetupCode("Hinnova", user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300);
