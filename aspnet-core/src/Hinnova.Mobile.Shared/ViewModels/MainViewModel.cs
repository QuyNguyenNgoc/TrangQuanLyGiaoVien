...
using MvvmHelpers;
using Hinnova.Authorization.Users.Profile;
using Hinnova.Authorization.Users.Profile.Dto;
using Hinnova.Commands;
using Hinnova.Core.Threading;
using Hinnova.Models.NavigationMenu;
using Hinnova.Services.Navigation;
...
using Hinnova.ApiClient;
using Hinnova.Controls;
using Hinnova.Dto;
using Hinnova.Extensions;
using Hinnova.Localization;
using Hinnova.UI;
using Hinnova.UI.Assets;
using Hinnova.Views;
using DependencyResolver = Hinnova.Core.Dependency.DependencyResolver;
...
namespace Hinnova.ViewModels
{
    public class MainViewModel : XamarinViewModel
    {
        ...
        private const string ApplicationName = "Hinnova";
