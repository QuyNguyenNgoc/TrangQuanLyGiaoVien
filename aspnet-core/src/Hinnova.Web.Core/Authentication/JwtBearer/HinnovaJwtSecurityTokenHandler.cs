...
namespace Hinnova.Web.Authentication.JwtBearer
{
    public class HinnovaJwtSecurityTokenHandler : ISecurityTokenValidator
    {
        private readonly JwtSecurityTokenHandler _tokenHandler;

        public HinnovaJwtSecurityTokenHandler()
        {
