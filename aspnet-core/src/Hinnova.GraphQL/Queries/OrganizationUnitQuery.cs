...
using Hinnova.Core.Base;
using Hinnova.Core.Extensions;
using Hinnova.Dto;
using Hinnova.Types;

namespace Hinnova.Queries
{
    public class OrganizationUnitQuery : HinnovaQueryBase<ListGraphType<OrganizationUnitType>, List<OrganizationUnitDto>>
    {
