...
{
    public class SessionAppService : HinnovaAppServiceBase, ISessionAppService
    {
        ...
        public async Task<GetCurrentLoginInformationsOutput> GetCurrentLoginInformations()
        {
            var output = new GetCurrentLoginInformationsOutput
            {
                Application = new ApplicationInfoDto
                {
                    ...
                    Currency = HinnovaConsts.Currency,
                    CurrencySign = HinnovaConsts.CurrencySign,
                    AllowTenantsToChangeEmailSettings = HinnovaConsts.AllowTenantsToChangeEmailSettings
                }
            };
