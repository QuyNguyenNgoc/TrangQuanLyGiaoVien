...
namespace Hinnova.MultiTenancy
{
    ...
    public class TenantAppService : HinnovaAppServiceBase, ITenantAppService
    {
        private readonly string connectionString;
        public IAppUrlService AppUrlService { get; set; }
        public IEventBus EventBus { get; set; }

        public TenantAppService(IWebHostEnvironment env)
        {
        ...
        public async Task<List<TenantListDto>> GetAllTenant()
        {
            using (SqlConnection conn = new SqlConnection(connectionString))
            {
                ...
                var result = await conn.QueryAsync<TenantListDto>(sql: "SELECT * FROM AbpTenants");
