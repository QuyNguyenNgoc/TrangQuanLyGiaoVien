...
{
    public class HinnovaDbContextUsersHealthCheck : IHealthCheck
    {
        private readonly IDbContextProvider<HinnovaDbContext> _dbContextProvider;
        private readonly IUnitOfWorkManager _unitOfWorkManager;

        public HinnovaDbContextUsersHealthCheck(
            IDbContextProvider<HinnovaDbContext> dbContextProvider,
