...
namespace Hinnova.Web.TagHelpers
{
    [HtmlTargetElement("script", Attributes = AbpSrcAttributeName)]
    public class HinnovaScriptSrcTagHelper : TagHelper
    {
        ...
        public HinnovaScriptSrcTagHelper(IWebHostEnvironment hostingEnvironment, IHttpContextAccessor httpContextAccessor)
        {
