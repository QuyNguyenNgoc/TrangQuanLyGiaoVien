$(function () {
    ...
    var toggleToolbarButtonsVisibility = function () {
        $(".deleteWidgetButton").toggleClass("d-none");
        $(".div-dashboard-customization").toggleClass("d-none");
    };

    var enableGrid = function () {
        toggleToolbarButtonsVisibility();
